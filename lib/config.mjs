...
export const CONFIG_KEYS = new Set([
  ...
  // Phase 4: token cost. `no-embed` restores the name-the-files prompt;
  // `budget` caps estimated input tokens; `triage` names a cheap first pass.
  'no-embed', 'budget', 'triage', 'hunk-context',
